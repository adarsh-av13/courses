...
Input Format:   The first line contains two numbers N denoting the number of songs in the playlist.
...
Output Format:  Output a single line containing the position of "Computing Paradox" in the sorted playlist.
...
Explaination:   N equals to 4, k equals to 2, A equals to {1, 3, 4, 2}. The answer is 3 because {1, 3, 4, 2} -> {1, 2, 3, 4}.
